...
print(
    "Fill a 2-mL syringe with 2 mL ethanol, connect the Luer-lock adapter to the tip, and insert it into the syringe pump."
)
print("")
command(ser, "G0Z274.67F200\r\n")  # Move to position for syringe 2 mL

print(
    "Connect the PTFE tube to the Luer-lock adapter and tighten it with the Lee torque wrench (min. torque)."
)
print("")
...
os.system("aplay --quiet BusinessEcho.wav")
print(
    "Now the fluidic system will be rinsed with 500 µL. The solvent will be ejected from the dispensing valve into the waste bottle."
)
print("")
...
try:
    ...
    os.system("aplay --quiet BusinessEcho.wav")
    print(
        "Now the dispensing valve was closed, and the syringe pump will build-up a pressure of 5 psi."
    )
    print("")
    command(ser, "G97P5\r\n")  # 5 psi
    command(
    ...
    os.system("aplay --quiet BusinessEcho.wav")
    print(
        "The dispensing valve will be opened to leave the pressure. Solvent will be ejected from the dispensing valve into the waste bottle."
    )
    print("")
    command(ser, "G40\r\n")  # Open valve
    time.sleep(1)
